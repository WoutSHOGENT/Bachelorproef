...
\label{uc:stockcorrectie-uitvoeren}
    ...
    \paragraph{Alternatieve verlopen}
    \begin{itemize}[nosep]
        \item[6A.] Het systeem detecteert dat de validatie volgens DR\_STOCKCORRECTIE\_FILTERS faalt.
        \begin{itemize}
        ...
        \begin{itemize}
            \item[8B1.] Het systeem vraagt om een bevestiging.
            \begin{itemize}
                \item[8B1A.] De gebruiker bevestigt de actie.
                \begin{itemize}
                    \item[8B1A1.] Het systeem toont een gepaste melding
                    \item[8B1A2.] We gaan verder naar stap 9
                \end{itemize}
                \item[8B1B.] De gebruiker bevestigt niet.
                \begin{itemize}
